    ...
    <div className="flex flex-col space-y-12 divide-y divide-gray-200 mb-32 ">
      <div>
        ...
        <p className="mt-3 mb-6 md:mb-7 sm:w-9/12 text-gray-300 md:w-10/12 lg:w-full text-base md:text-lg font-medium ">
          I&apos;m a full-stack developer <Emoji emoji="👨‍💻" label="man with a computer" /> from Spain. Free software
          contributor <Emoji emoji="❤️" label="hearth" />, Linux fan <Emoji emoji="🐧" label="penguin" /> and DevOps{' '}
          <Emoji emoji="⚙️" label="gear" /> soul.
        </p>
      </div>
    </div>
  )
