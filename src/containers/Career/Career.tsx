      ...
      <ul className={styles.career}>
        {career.map((step, index) => (
          <li className={styles.step} key={step.title}>
            <picture>
              <source srcSet={`${step.imageUrl}.webp`} type="image/webp" />
              <img src={`${step.imageUrl}.png`} alt="" className={styles.stepImage} />
            </picture>
            <CareerStep
              date={step.date}
              title={step.title}
